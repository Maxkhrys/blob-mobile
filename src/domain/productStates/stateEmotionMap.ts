...
export const CANONICAL_PRODUCT_STATES: readonly ProductStateMeta[] = [
  { id: 'HOME', label: 'Home', accent: '#6D5BD0', description: 'Autonomous peaceful resting' },
  { id: 'SENSED', label: 'Sensed', accent: '#5B6BD0', description: 'Peripheral notice of companion' },
  { id: 'APPROACHING', label: 'Approaching', accent: '#4F86C6', description: 'Closing distance vector' },
  { id: 'VERY_CLOSE', label: 'Very Close', accent: '#3FA9A0', description: 'Immediate proximity contact' },
  { id: 'TOGETHER', label: 'Together', accent: '#54A86B', description: 'Co-cruising side-by-side' },
  { id: 'SYNC', label: 'Sync', accent: '#B99A4F', description: 'Harmonic breathing & movement' },
  { id: 'CONNECTED', label: 'Connected', accent: '#C4744F', description: 'Unbroken emotional link' },
  { id: 'RECOGNIZED', label: 'Recognized', accent: '#B0587E', description: 'Instant greeting of known friend' },
  { id: 'GOODBYE', label: 'Goodbye', accent: '#4F46E5', description: 'Farewell and saved to memory' },
] as const;
...
export const STATE_EMOTION_MAP: Record<ProductState, StateEmotionConfig> = {
  ...
  SENSED: {
    ...
    expressionId: 'CURIOUS_WIDE',
    performanceId: 'CURIOUS_DOUBLE_TAKE',
    description: 'First notice of presence at periphery. Alert double-take and focal lock.',
    intimacyLevel: 0.3,
    bodyLean: 2,
    depthBias: 0.1,
    pupilDilation: 1.15,
  ...
  APPROACHING: {
    ...
    expressionId: 'CURIOUS_TILT_LEFT',
    performanceId: 'CURIOUS_DOUBLE_TAKE',
    description: 'Friend is stepping closer. Eyes widen, head pitches forward, following motion.',
    intimacyLevel: 0.5,
    bodyLean: 5,
    depthBias: 0.25,
    pupilDilation: 1.2,
  ...
  VERY_CLOSE: {
    ...
    expressionId: 'EXCITED_EYES',
    performanceId: 'EXCITED_WIGGLE',
    description: 'Friend is right at the glass. High emotional arousal and joyful anticipation.',
    intimacyLevel: 0.75,
    bodyLean: 8,
    depthBias: 0.45,
    pupilDilation: 1.3,
  ...
  CONNECTED: {
    ...
    expressionId: 'HAPPY_EYES',
    performanceId: 'LAUGH_SQUISH',
    description: 'Unbroken emotional link. Radiant expressions, relaxed posture, affectionate micro-glances.',
    intimacyLevel: 0.98,
    bodyLean: 3,
    depthBias: 0.4,
    pupilDilation: 1.25,
  ...
  GOODBYE: {
    ...
    expressionId: 'SOFT_SQUINT',
    performanceId: 'BODY_SETTLE',
    description: 'Gentle parting glance, fading softly into memory while holding resting pose.',
    intimacyLevel: 0.2,
    bodyLean: -2,
    depthBias: -0.1,
    pupilDilation: 0.95,
